...
/* harmony import */ var _RevealerTransition__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./RevealerTransition */ "./src/js/RevealerTransition.js");
...
var CommonView=barba__WEBPACK_IMPORTED_MODULE_0___default.a.BaseView.extend({namespace:'common',scrollWatchers:[],onEnterCompleted:function onEnterCompleted(){try{$(document).foundation();$('body').addClass('animations-enabled');window.scrollTo(0,0);var _instance=this;if(typeof ga==='function'){ga('send','pageview',location.pathname);}// run element animations when in viewport
...
barba__WEBPACK_IMPORTED_MODULE_0___default.a.Pjax.init();barba__WEBPACK_IMPORTED_MODULE_0___default.a.Pjax.getTransition=function(){return _RevealerTransition__WEBPACK_IMPORTED_MODULE_3__["default"];};// hide preloader 
